...
describe("Divide Two Numbers", function() {
  var url = "http://localhost:8080/DivideTwoNumbers/27/3";
...
it("returns the result not equal to 36", function(done) {
  request(url, function(error, response, body) {
      body = JSON.parse(body);
      expect(body.result).to.not.equal(36);
      done()
    });
});
});
...
describe("Multiply Two Numbers", function() {
  var url = "http://localhost:8080/MultiplyTwoNumbers/3/8";
  it("returns status 200 to check if api works", function(done) {
      request(url, function(error, response, body) {
          expect(response.statusCode).to.equal(200);
          done()
  ...
  it("returns the result equal to 24", function(done) {
    request(url, function(error, response, body) {
        body = JSON.parse(body)
        expect(body.result).to.equal(24);
        done()
      });
});
it("returns the result not equal to 53", function(done) {
  request(url, function(error, response, body) {
      body = JSON.parse(body);
      expect(body.result).to.not.equal(53);
      done()
    });
});
});
